...
/* The tasks handlers to be created. */
...
( this is the handle of the created semaphore.............)
a7na 2olna kol semaphore b3mlo create byb2a leh control block bardo f el heap
fa el semaphore handle da howa el by4awr 3ala el control block da....... */
xSemaphoreHandle xWork;

/* this is the queue which manager uses to put the work ticket id (queue handle)*/
...
int main( void )
{
     ...
     * this is the API which we use to create a Binary semaphore
     * it takes one argument which is the handle of the semaphore which is defined globally */
 ...
 void vManagerTask( void *pvParameters )
{
    ...
    /* The semaphore is created in the 'empty' state, meaning the semaphore must
	 ...
	 ----------------------------------------------------------------
	 lama bt3ml creating ll semaphore el awl byb2a fady (empty) fa lazm el awl t7otelo 7aga y3ny t3mlo increment
	 y3ny ....fa yb2a feh 7aga ......feh key y3ny ....... fa lazm t3ml call ll API dy f el awl abl ma tst3ml el
	 semaphore...........aw3a tensa.........................*/
    ...
    for( ;; )
    {
		...
		}else
		{
			 ...
			 * hena el manager by3ml b2a give ll semaphore ll employee ......fa lama tro7 ll employee htal2eh
			 * by3ml take ll semaphore da.................. */
			xSemaphoreGive( xWork);
...
static void vEmployeeTask( void *pvParameters )
{
    ...
    for( ;; )
    {
		 ...
		 * dy el API el bst3mlha 34an a-take semaphore.........
		 * w bta5od 2 arguments ....awl wa7d el semaphore handle w tany wa7d da el time ely el employee task
		 * hystnah lw el semaphore m4 available l7d ma el semaphore yb2a available............. */
