...
/* global vars.....*/
uint32_t flag = 0; // tb3an mfy4 7aga asmha zero w 1 ...lazm tb2a declared macros...bs da sho3'l sare3 kda...
...
// creating LED task.....
xTaskCreate(vTask1_Handler,"Task1",500,NULL,2,&task1_handle);

// creating Buttin task.....
xTaskCreate(vTask2_Handler,"Task2",500,NULL,3,&task2_handle);
...
{
	// bardo zay el TIVAC ......awl 7aga b3mlha eny b-clear el interrupt bit f el awl 5als awl ma b5o4...
	// 34an lama a3mlha setting b 1 kda m3nah en el interrupt geh f3lan ... fa lazm adman el awl enha mtsafara...m3molha clear....
    // b3ml el kalam da ezay ?? b API bardo..
...
void vTask1_Handler(void * para) /* 2olna bta5od pointer wa7d bs .....w 2olna btrg3 void....aftkr shakl el handler function...*/
 {
    ...
    while(1)
    {
    	// lw el flag b 1......kda el button etdas.....fa h3'yr el priorities....
    	if(flag)
    	{
    	    // awl 7aga raga3 el flag b zero zay ma kan.........
    		flag = 0;
    		// h3'yr el priorities b2a...........
     		  // first... change task1 to have a priority of "2"
      		  vTaskPrioritySet(task1_handle,2);
      		  // second ....change task2 to have a priority of "3"
      		  vTaskPrioritySet(task2_handle,3);

    	}
    	else
    	{
    		// keep toggling the LED........lesa el button mtdas4 .... fa 3ady sha3'al task1 zay ma howa....
    		// tb3an Task1 ht3ml toggle ll LED kol 100ms.........
    		 GPIO_ToggleBits(GPIOA,GPIO_Pin_5);
    		 rtos_delay(100);//hena m4 m7tag vTaskDelete...la2n ana 3ayz a3ml delay 3ady 5als m4 3ayz a7ot el task f el blocking state...
...
void vTask2_Handler(void * para) /* 2olna bta5od pointer wa7d bs .....w 2olna btrg3 void....aftkr shakl el handler function...*/
  {
      while(1)
      {
    	  // Task2 bt3ml toggle ll LED kol 1 sec......w lama el button yetdas bt3ml changing priority.......
    	  //fa h-check el button etdas wla la2.......
    	  // tb3an el button da Pull-up .... fa lw etdas hywsl zero ...fa h3ml checking 3ala el zero....
    	  if(flag)
		  {
    		  // awl 7aga raga3 el flag b zero zay ma kan.........
    		     flag = 0;
    		     // h3'yr el priorities b2a...........
    		     // first... change task1 to have a priority of "3"
    		     vTaskPrioritySet(task1_handle,3);
    		     // second ....change task2 to have a priority of "2"
    	  ...
    	  else
    	  {
    		  // keep toggling the LED........lesa el button mtdas4 .... fa 3ady sha3'al task1 zay ma howa....
    		   // tb3an Task1 ht3ml toggle ll LED kol 100ms.........
    		   GPIO_ToggleBits(GPIOA,GPIO_Pin_5);
    	       rtos_delay(1000); // hena m4 m7tag vTaskDelete.....hena ana bs 3ayz a3ml delay 3ady...m4 3ayz a7otha f el blocked state......
    	  }
