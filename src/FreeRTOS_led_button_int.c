...
void Button_Handler() /* 2olna bta5od pointer wa7d bs .....w 2olna btrg3 void....aftkr shakl el handler function...*/
  {
    flag ^= 1; // toggle.......using XOR...
  }
...
void EXTI15_10_IRQHandler()
{
	...
	// w howa 3aml function asmha button_handler dy b2a el bt3'ayar el flag y3ny...( Button Handler )
	Button_Handler();
