...
// creating LED task.....
xTaskCreate(vTask1_Handler,"Task1",500,NULL,1,&task1_handle);

// creating Buttin task.....
xTaskCreate(vTask2_Handler,"Task2",500,NULL,2,&task2_handle);
...
void vTask1_Handler(void * para) /* 2olna bta5od pointer wa7d bs .....w 2olna btrg3 void....aftkr shakl el handler function...*/
 {
    ...
    while(1)
    {
    	// tb3an Task1 ht3ml toggle ll LED kol 200ms.........
    	vTaskDelay(200); // this function is used instead of rtos_delay()................
...
void vTask2_Handler(void * para) /* 2olna bta5od pointer wa7d bs .....w 2olna btrg3 void....aftkr shakl el handler function...*/
  {
      while(1)
      {
    	  // Task2 bt3ml toggle ll LED kol 1ms......w lama el button yetdas bt3ml delete l nafsha.......
		  ...
		  {
			 // kda el button not pressed ......fa h3ml toggle ll LED kol 1 sec(1000 ms)................
    		  rtos_delay(1000);
			  GPIO_ToggleBits(GPIOA,GPIO_Pin_5);
		  }
    	  else
    	  {
    		  // kda el button pressed......
    		  // fa hmsa7 el task....
    		  // hena el task btms7 nafsha fa m4 lazm ab3at el task handle...ab3at NULL w 5las...
    		  // lakn lw vTask2_handler dy msln btms7 Task1 b2a....sa3tha lazm ab3at el task handle bta3 task1
    		  // lakn hena task2 btms7 nafsha .... fa hb3at NULL 3ady....
    		  vTaskDelete(NULL);
    	  }
